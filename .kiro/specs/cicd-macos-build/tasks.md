...
- [x] 4.1 クロスプラットフォームビルドエラーハンドリングの実装
...
- [x] 6. クロスプラットフォームGitHubリリース自動化の実装
  - リリース作成の自動化
  - dmgとmsiファイルの両方のアセット添付
  - リリースノートの自動生成
  - _要件: 6.1, 6.2, 6.3_

- [x] 6.1 クロスプラットフォームGitHubリリース作成の実装
  - バージョンタグの自動生成
  - GitHubリリースの作成（両ビルド完了後）
  - dmgとmsiファイルの両方をリリースアセット添付
  - _要件: 6.1, 6.2_

- [x] 6.2 リリースノート自動生成の実装
...
- [x] 9. クロスプラットフォーム署名とセキュリティ機能の実装
  - MacOSとWindowsでのアプリケーション署名設定
  - 両プラットフォームでの署名済み実行可能ファイル検証
  - _要件: 2.2, 3.2_

- [x] 9.1 クロスプラットフォームアプリケーション署名の設定
  - macOS用のコード署名設定
  - Windows用のコード署名設定
  - プラットフォーム固有の署名証明書設定
  - _要件: 2.2, 3.2_
